# Web Development Project 5 - *60min Recipe Finder*

Submitted by: **Maiwand Raheem**

This web app: **Helps users find recipes that take under an hour to make and can be filterd based on time. (using the spoonacular API)**
...
API units ran out before submission
